...
WHY we customize this file:
- We need Alembic to use our app's database URL (from .env / config.py)
- We need Alembic to see our SQLAlchemy models (for autogenerate)
- Default Alembic env.py doesn't know about our app's configuration
"""
...
from app.models import (
    ...
    Order, OrderItem, Experiment,
    ExperimentResult, Assignment, Event,
)
